...
class GarminSDComms {
  ...
  // negative for transport errors (treated as comms failures); appendCommsLabel adds "COMMS".
  private function setCommsStatus(responseCode as Number or Null, appendCommsLabel as Boolean) as Void {
